        ...
        <>
            ...
            <div className="w-full h-[90vh] customFlex">
                <div className="flex flex-col items-center gap-8 w-[50%]">
                    ...
                    <p className="text-center leading-8 text-[#666] text-lg">We are sorry, the page you were looking for is either under construction or no longer exits. Let's find a better place for you to go.</p>
